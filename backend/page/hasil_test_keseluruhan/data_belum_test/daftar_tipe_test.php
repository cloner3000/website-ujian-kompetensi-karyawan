                       ...
                       <thead>
                        ...
                        ?>
                         <tr>
                            ...
                            <td>
                               <a href="?page=laporan_belum_test&aksi=data_laporan_belum_test&nama_pelatihan=<?php echo $nama_pelatihan;?>&nama_tipe_test=<?php echo $data['nama_tipe_test'];?>" class="btn btn-info">Masuk</a>
                            </td>
                        </tr>
                        <?php } ?> 
                    </table>
                  </div>
                  <a href="?page=laporan_belum_test" class="btn btn-success" style="margin-top: 10px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></i> Kembali</a>
