...
<div class="row">
          <div class="col-md-12 col-sm-12">
              <div class="panel panel-primary">
                  ...
                  <h2 align="center">Silahkan pilih tipe soal test yang akan di kelola : </h2>
                       ...
                       <thead>
                        ...
                        ?>
                         <tr>
                            ...
                            <td>
                               <a href="?page=soal_ujian&aksi=data_soal&nama_pelatihan=<?php echo $nama_pelatihan;?>&nama_tipe_test=<?php echo $data['nama_tipe_test'];?>" class="btn btn-info">Masuk</a>
                            </td>
                        </tr>
                        <?php } ?> 
                    </table>
